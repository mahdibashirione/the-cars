...
const InputCustom = ({ type = "text", inputMode = "decimal", id, name, label, placeholder, formik }) => {
    ...
    <div className="flex flex-col w-full md:w-[calc(50%-1.25rem)]">
      ...
      <input
        ...
        className={`${formik.touched[name] && formik.errors[name] && "ring-4 ring-red-400"} outline-none w-full bg-gray-200
         dark:bg-zinc-700 text-slate-600 dark:text-slate-400 px-4 py-3 rounded-lg focus:ring-4`}
      />
