...
const Banner = () => {
  ...
  const [data, setData] = useState([
    { id: 1, title: "The Best Platform for Car Rental", caption: "Ease of doing a car rental safely and reliably. Of course at a low price.", url: "/", imageCar: "/images/Koenigsegg.svg", },
    { id: 1, title: "Easy way to rent a car at a low price", caption: "Providing cheap car rental services and safe and comfortable facilities.", url: "/", imageCar: "/images/NissanGT-R.svg", },
  ])

  const BannerCard = ({ detail }) => {
    return (
      <aside className="w-full relative shadow min-w-[325px] min-h-full rounded-[10px] p-4 text-white bg-gradient-to-tr from-blue-300 to-blue-500">
