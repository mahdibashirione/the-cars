const Footer = () => {
  return (
    <footer className="w-full p-4 pt-16 md:pt-20 md:bg-white">
      <div className="w-full container justify-between gap-y-12 flex flex-col md:flex-row text-slate-800">
        ...
        <div className="w-full md:w-2/3 whitespace-nowrap md:justify-end flex flex-wrap gap-x-16 md:gap-x-14 gap-y-11">
          ...
          <div className="select-none">
            <span className="lg:text-lg font-bold">About</span>
            <div className="flex flex-col gap-y-3 lg:gap-y-4 mt-4 lg:mt-6 text-gray-500 text-sm">
          ...
          <div className="select-none">
            <span className="lg:text-lg font-bold">Community</span>
            <div className="flex flex-col gap-y-3 lg:gap-y-4 mt-4 lg:mt-6 text-gray-500 text-sm">
      ...
      <div className="select-none container w-full flex flex-wrap md:justify-between gap-y-8 text-sm lg:text-base border-t border-gray-300 mt-9 pt-9 pb-12 ">
