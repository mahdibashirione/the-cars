    ...
    <header className="w-full bg-white dark:bg-zinc-800">
      <div className="w-full container p-4 flex justify-between items-center flex-wrap gap-y-4">
        ...
        <div className="h-full flex items-center gap-x-3 lg:gap-x-4">
          ...
          {/*<div className="hidden dark:border-zinc-900 md:dark:hover:bg-zinc-900 hover:bg-blue-200 hover:border-blue-200 duration-300 relative w-11 h-11 lg:flex items-center justify-center rounded-full border-2 cursor-pointer">
